<template>
  <v-app>
    ...
    <v-navigation-drawer app >
      <v-list class="pa-0">
        <v-list-item style="background: #53BBB2;" class="py-1" @click="goRoute('/')">
            <img
              src="./assets/logo.png"
              alt="Logo"
              width="100%"
      ...
      <v-list v-else>
        ...
        >
          ...
          >
            <v-list-item-content>
              <v-list-item-title v-text="item.text" class="mb-4"></v-list-item-title>
...
<script>
  ...
  export default {
    ...
    data: () => ({
      ...
      items2: [{
        icon: null,
        text: "臺灣高等法院 102 年度上易字第 484 號第 484 號",
        progress: 30
      },{
        icon: null,
        text: "臺灣高等法院 102 年度上易字第 484 號第 484 號",
